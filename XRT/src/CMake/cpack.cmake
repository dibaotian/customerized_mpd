...
if (${LINUX_FLAVOR} MATCHES "^(Ubuntu|Debian|pynqlinux)")
  ...
  SET(CPACK_DEBIAN_CMCC_PACKAGE_CONTROL_EXTRA "${CMAKE_CURRENT_BINARY_DIR}/cmcc/postinst;${CMAKE_CURRENT_BINARY_DIR}/cmcc/prerm")
...
elseif (${LINUX_FLAVOR} MATCHES "^(RedHat|CentOS|Amazon)")
  ...
  SET(CPACK_RPM_CMCC_POST_INSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/cmcc/postinst")
  SET(CPACK_RPM_CMCC_PRE_UNINSTALL_SCRIPT_FILE "${CMAKE_CURRENT_BINARY_DIR}/cmcc/prerm")
